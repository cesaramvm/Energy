...
public class MetaResults {
	...
	public MetaResults(MetaSolution bestSolution, Long totalSecuentialTime, Long totalConcurrentTime, Long avgTime,
			Double avgError) {
	...
	public String toString() {
		return "MetaResults{" + "bestSolution=" + bestSolution + ", totalSecuentialTime=" + totalSecuentialTime
				+ ", totalThreadedTime=" + totalConcurrentTime + ", avgError=" + avgError + ", avgTime=" + avgTime
				+ '}';
	}
